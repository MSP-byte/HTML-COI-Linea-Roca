...
assert.match(html, /principalSeguro=validarUrlDocumental\(s\.principal\)/);
assert.match(html, /href=validarUrlDocumental\(l\.url\)/);
...
console.log('Integridad local: caché protegida, restore con rollback y mutaciones críticas por RPC.');
