...
assert.match(html, /client\.rpc\('coi_certificar_posiciones'/);
...
assert.match(html, /\.rpc\('coi_confirmar_etapa_circuito'/);
...
for (const [name, sql] of [['preflight', preflight], ['ledger', ledger], ['orders', orders], ['rls', rls], ['operations', operations]]) {
...
console.log('Contrato Supabase: ledger, órdenes, circuito, links, RPC atómicas y RLS verificados.');
