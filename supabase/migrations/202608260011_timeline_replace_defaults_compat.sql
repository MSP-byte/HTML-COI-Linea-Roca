-- COI Linea Roca - compatibilidad del restore Timeline luego de la serializacion 010.
-- Forward-only: 010 ya fue validada/aplicada en staging, por lo que esta correccion
-- redefine solamente replace manteniendo el advisory lock comun y sin limite 5000.
...
comment on function public.coi_timeline_replace_events(jsonb) is
  'Restore Timeline atomico, serializado y sin limite artificial de 5000; conserva defaults compatibles para snapshots parciales.';
